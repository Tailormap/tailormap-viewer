...
export class IconService {
  ...
  public icons: IconDefinition[] = [
    ...
    { folder: 'components', icons: [
      'attribute_list', 'legend', 'table_of_contents', 'drawing', 'print', 'filter', 'coordinate_link_window', 'info_menu_button', 'component_buttons',
      ] },
    {
      folder: 'tools',
      icons: [
        ...
        'streetview', 'share', '3d', 'terrain', 'terrain_low_weight', 'background_layers',
      ],
    },
