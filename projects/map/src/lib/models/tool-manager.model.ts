...
import { ToolsStatusModel } from './tools-status.model';
...
export interface ToolManagerModel {
  ...
  enableTool<T = Record<string, unknown>>(toolId?: string, disableOtherTools?: boolean, enableArgs?: T, forceEnableIfActivated?: boolean): ToolManagerModel;
