import { FilterConditionEnum, FilterToolEnum, FilterTypeEnum, AttributeType } from '@tailormap-viewer/api';
  ...
  describe('separateSubstringFiltersInCheckboxFilters', () => {
    ...
    it('should separate substring filters from checkbox filters', () => {
      const filterGroup = getFilterGroup([{
        ...
        attribute: 'status',
        attributeType: AttributeType.STRING,
        condition: FilterConditionEnum.STRING_IN_KEY,
        ...
        editConfiguration: {
          ...
          attributeValuesSettings: [
            ...
            { value: 'pending', label: 'Pending', initiallySelected: false, useAsIlikeSubstringFilter: true },
          ],
        },
      }]);
    ...
    it('should only create substring filters for values marked with useAsIlikeSubstringFilter', () => {
      const filterGroup = getFilterGroup([{
        ...
        editConfiguration: {
          ...
          attributeValuesSettings: [
            { value: 'active', label: 'Active', initiallySelected: true, useAsIlikeSubstringFilter: true },
            { value: 'pending', label: 'Pending', initiallySelected: false, useAsIlikeSubstringFilter: false },
            { value: 'completed', label: 'Completed', initiallySelected: true, useAsIlikeSubstringFilter: true },
          ],
        },
      }]);
