...
import { selectCQLFilters, selectSpatialFilterGroupsWithReferenceLayers } from '../../state/filterState/filter.selectors';
...
import { updateFilterGroup } from '../../state/filterState/filter.actions';
